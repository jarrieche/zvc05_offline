sap.ui.define([
	...
	return ManagedObject.extend("com.vc05.offline.zvc05offline.controller.SelectDialog03", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.vc05.offline.zvc05offline.view.SelectDialog03", this);
			this._bInit = false;
		},
		exit: function () {
			delete this._oView;
