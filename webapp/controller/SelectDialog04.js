sap.ui.define([
	...
	return ManagedObject.extend("com.vc05.offline.zvc05offline.controller.SelectDialog04", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.vc05.offline.zvc05offline.view.SelectDialog04", this);
			this._bInit = false;
		},
		exit: function () {
			delete this._oView;
		...
		_onSelectDialogLiveChange: function (oEvent) {
			...
			return new Promise(function (fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					aFilters.push(new sap.ui.model.Filter("Vkbur", sap.ui.model.FilterOperator.Contains, sQuery));
