sap.ui.define([
	...
	return ManagedObject.extend("com.vc05.offline.zvc05offline.controller.SelectDialog06", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.vc05.offline.zvc05offline.view.SelectDialog06", this);
			this._bInit = false;
		},
		exit: function () {
			delete this._oView;
		...
		_onSelectDialogLiveChange: function (oEvent) {
			...
			return new Promise(function (fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					aFilters.push(new sap.ui.model.Filter("Kunnr", sap.ui.model.FilterOperator.Contains, sQuery));
					aFilters.push(new sap.ui.model.Filter("Mcod1", sap.ui.model.FilterOperator.Contains, sQuery));
				}
