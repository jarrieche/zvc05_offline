sap.ui.define([
	...
	return ManagedObject.extend("com.vc05.offline.zvc06offline.controller.SelectDialog09", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.vc06.offline.zvc06offline.view.SelectDialog09", this);
			this._bInit = false;
		},
		exit: function () {
			delete this._oView;
		...
		_onSelectDialogLiveChange: function (oEvent) {
			...
			return new Promise(function (fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					aFilters.push(new sap.ui.model.Filter("Pernr", sap.ui.model.FilterOperator.Contains, sQuery));
					aFilters.push(new sap.ui.model.Filter("Vorna", sap.ui.model.FilterOperator.Contains, sQuery));
				}
