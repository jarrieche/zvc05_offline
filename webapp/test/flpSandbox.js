		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App VC05 Offline",
									"targetURL": "#AppVC05Offline-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AppVC05Offline-display": {
								"semanticObject": "AppVC05Offline",
								"action": "display",
								"description": "App VC05 Offline",
								"title": "App VC05 Offline",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vc05.offline.zvc05offline",
									"url": sap.ui.require.toUrl("com/vc05/offline/zvc05offline")
								}
							}
						}
					}
